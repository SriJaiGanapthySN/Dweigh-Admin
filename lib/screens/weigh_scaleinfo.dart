...
class WeighScaleinfo extends StatefulWidget {
  const WeighScaleinfo({super.key, required this.name, required this.number});

  final String name;
  final String number;
  @override
  State<WeighScaleinfo> createState() => _WeighScaleinfoState();
}

class _WeighScaleinfoState extends State<WeighScaleinfo> {
